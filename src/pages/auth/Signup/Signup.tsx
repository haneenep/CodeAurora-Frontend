      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-48 right-96">
            <TechIcon label="</>" bgColor="bg-gray-800" />
          </div>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 w-full max-w-md relative z-10">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-ubuntu-mono mb-2">Sign Up</h1>
            <p className="text-xl text-gray-600">Welcome to CodeAurora</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus: ~  focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-all"
            />
            <input
              type="email"
